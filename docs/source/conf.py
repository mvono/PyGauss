...
MOCK_MODULES = ['numpy', 'scipy.linalg', 'math', 'sklearn.covariance']
...
latex_documents = [
    (master_doc, 'PyGauss.tex', 'PyGauss Documentation',
     'Maxime Vono', 'manual'),
]
...
man_pages = [
    (master_doc, 'pygauss', 'PyGauss Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyGauss', 'PyGauss Documentation',
     author, 'PyGauss', 'One line description of project.',
     'Miscellaneous'),
]
